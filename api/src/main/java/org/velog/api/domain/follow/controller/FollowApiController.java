...
public class FollowApiController {
    ...
    public ResponseEntity<Api<String>> userFollow(
        ...
        followBusiness.follow(userDto, loginId);
    ...
    public ResponseEntity<Api<String>> userUnFollow(
        ...
        followBusiness.unFollow(userDto, loginId);
    ...
    public ResponseEntity<Api<List<FollowResponse>>> getMyFollowerDetail(
        ...
        List<FollowResponse> followResponseList = followBusiness.getMyFollowerDetails(userDto);
    ...
    public ResponseEntity<Api<Integer>> getMyFollowCount(
        ...
        Integer count = followBusiness.getMyFollowCount(userDto);
