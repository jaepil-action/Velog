...
public class CommentApiController {
    ...
    public ResponseEntity<Api<CommentResponse>> createComments(
        ...
        CommentResponse commentResponse = commentBusiness.registerCommentByPost(user, postId, commentRegisterRequest);
    ...
    public ResponseEntity<Api<CommentResponse>> createChildComments(
        ...
        CommentResponse commentResponse = commentBusiness.registerCommentByParent(user, postId, parentId, commentRegisterRequest);
        return ResponseEntity.status(HttpStatus.CREATED).body(Api.CREATED(commentResponse));
    }
    ...
    public ResponseEntity<Api<String>> deleteComments(
        ...
        commentBusiness.deleteCommentByPost(user, postId, commentId);
    ...
    public ResponseEntity<Api<String>> editComments(
        ...
        commentBusiness.editComment(user, commentId, commentRegisterRequest);
